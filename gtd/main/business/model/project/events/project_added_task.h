...
namespace gtd {
    struct project_added_task : skizzay::simple::cqrs::event_base<project_added_task> {
        static constexpr std::string_view event_type_name = "project_added_task";
        ...
        friend std::ostream &operator<<(std::ostream &os, project_added_task const &instance) {
        ...
        friend skizzay::s11n::binary_writer<D, E> &operator<<(skizzay::s11n::binary_writer<D, E> &writer,
                                                              project_added_task const &instance
        ) {
