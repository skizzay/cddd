...
struct project_task_completed final : skizzay::simple::cqrs::event_base<project_task_completed> {
    static constexpr std::string_view event_type_name = "project_task_completed";
    ...
    friend std::ostream &operator<<(std::ostream &os, project_task_completed const &instance) {
    ...
    friend skizzay::s11n::binary_writer<D, E> &operator<<(skizzay::s11n::binary_writer<D, E> &writer,
                                                          project_task_completed const &instance
    ) {
    ...
    friend skizzay::s11n::binary_reader<D, E> &operator>>(skizzay::s11n::binary_reader<D, E> &reader,
                                                          project_task_completed &instance
    ) {
